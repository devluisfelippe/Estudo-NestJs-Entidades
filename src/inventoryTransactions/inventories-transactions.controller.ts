...
export class InventoriesTransactionsController {
    constructor(private inventoriesTransactionsService: InventoriesTransactionsService) { }
    ...
    async createTransactionInventory(
        ...
        try {
            await this.inventoriesTransactionsService.createTransaction(new_transaction.product_id, new_transaction.quantity, lot_id, auth.user.company_id);
